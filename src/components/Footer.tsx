    ...
    <footer className="bg-white">
      <div className="container mx-auto px-6 py-8 sm:px-8 sm:py-10">
        <div className="mb-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div><h2 className="text-lg font-black text-stone-900">{settings.storeName}</h2><p className="mt-2 max-w-md text-sm leading-6 text-stone-500">{settings.businessName || settings.storeName}</p></div>
