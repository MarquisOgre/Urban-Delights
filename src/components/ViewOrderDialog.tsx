  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Order Details - {getInvoiceNumber(order)}</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b pb-4">
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-lg font-semibold">Invoice: {getInvoiceNumber(order)}</h3>
                <p className="text-sm text-gray-600">Created: {new Date(order.created_at).toLocaleDateString('en-IN')}</p>
              </div>
