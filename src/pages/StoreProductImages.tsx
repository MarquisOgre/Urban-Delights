...
export default function StoreProductImages() {
  ...
  return <div className="flex min-h-screen flex-col bg-slate-50"><main className="flex-1 px-4 py-6 sm:px-6 lg:px-8"><div className="mx-auto max-w-6xl space-y-6">
  ...
  </div></main><Footer showTopButton showNavigation={false} /></div>;
}
