                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Saturday - Sunday <br /> 9:00 AM - 2:00 PM</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="rounded-lg overflow-hidden shadow-lg w-full h-[400px]">
            <iframe
              title="Artisan Delights Map"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.278179800806!2d78.38092387494926!3d17.442282901084917!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb93e3296b6a23%3A0x992002d5a04e6fa!2sHITEC%20City%2C%20Hyderabad%2C%20Telangana%20500081!5e0!3m2!1sen!2sin!4v1720557278745!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
