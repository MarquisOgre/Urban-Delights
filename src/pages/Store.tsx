...
const Store = () => {
  ...
  return <div className="min-h-screen bg-stone-50 text-stone-900 pb-8">
    <header className="sticky top-0 z-40 border-b border-stone-200 bg-white/95 backdrop-blur"><div className="container flex h-[72px] items-center justify-between gap-4 px-4 sm:px-6">
      <Link to="/" aria-label="Urban Delights home"><img src="/logo.png" alt="Urban Delights" className="h-10 w-auto sm:h-12" /></Link>
      <div className="flex items-center gap-3"><Link to="#products" className="hidden text-sm font-medium text-stone-600 hover:text-orange-700 sm:block">Shop</Link><Link to="#story" className="hidden text-sm font-medium text-stone-600 hover:text-orange-700 sm:block">Our Promise</Link>
    ...
    <main>
      <section className="relative overflow-hidden border-b border-stone-200 bg-gradient-to-br from-orange-50 via-amber-50 to-stone-100">
        <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-orange-200/30 blur-3xl" /><div className="absolute -bottom-32 left-0 h-80 w-80 rounded-full bg-yellow-200/25 blur-3xl" />
        <div className="container relative grid min-h-[500px] items-center gap-10 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.05fr_.95fr] lg:py-24">
          <div className="max-w-2xl"><div className="mb-5 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-white/70 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-orange-800"><Sparkles className="h-3.5 w-3.5" /> Small-batch · South Indian flavours</div><h1 className="text-4xl font-bold leading-[1.05] tracking-tight text-stone-950 sm:text-6xl lg:text-7xl">The taste of <span className="text-orange-700">home</span>, ground fresh.</h1><p className="mt-6 max-w-xl text-base leading-7 text-stone-600 sm:text-lg">Authentic podis and masalas made in small batches with carefully selected ingredients — full of aroma, warmth and the flavours you grew up with.</p><div className="mt-8 flex flex-wrap gap-3"><Button asChild size="lg" className="rounded-full bg-stone-900 px-7 text-white hover:bg-orange-700"><Link to="#products">Shop our blends <ArrowRight className="ml-2 h-4 w-4" /></Link></Button><Button asChild variant="outline" size="lg" className="rounded-full border-stone-300 bg-white/60"><Link to="#story">Why Urban Delights?</Link></Button></div><div className="mt-8 flex flex-wrap gap-6 text-sm text-stone-600"><span className="flex items-center gap-2"><Leaf className="h-4 w-4 text-orange-700" /> Thoughtfully sourced</span><span className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-orange-700" /> Made with care</span></div></div>
