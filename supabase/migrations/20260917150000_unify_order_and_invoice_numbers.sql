-- Unify the customer-facing Order ID and Admin Invoice ID.
-- Format: UD-YYYY-XXXX (4-digit sequence).
-- The database primary key remains UUID; the displayed business ID is derived
-- from invoice_number and is intentionally identical in storefront and admin.
...
IS 'Guest storefront checkout. Returns the same business Order ID shown as the Admin Invoice ID: UD-YYYY-XXXX.';
